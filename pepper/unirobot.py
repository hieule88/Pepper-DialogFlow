...
class Pepper:
    ...
    **Real robot controller**
    ...
    def __init__(self, ip_address, port=9559):
        ...
        ssh.connect(hostname=self.ip_address, username="nao", password="ThanhTruc0301@")
        ...
        self.list_explain = ['System/animations/Stand/Gestures/Explain_1', 'System/animations/Stand/Gestures/Explain_2', 'System/animations/Stand/Gestures/Explain_3',\
                            'System/animations/Stand/Gestures/Explain_6', 'System/animations/Stand/Gestures/Explain_5', 'System/animations/Stand/Gestures/Explain_4',\
                            'System/animations/Stand/Gestures/Explain_7', 'System/animations/Stand/Gestures/Explain_8']

        self.list_bodytalk = ['System/animations/Stand/BodyTalk/Speaking/BodyTalk_1',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_10',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_11',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_12',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_13',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_14',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_15',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_16',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_2',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_3',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_4',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_5',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_6',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_7',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_8',
                            'System/animations/Stand/BodyTalk/Speaking/BodyTalk_9',]
        self.active_entertain = True

        print("[INFO]: Robot is initialized at " + ip_address + ":" + str(port))

    def tablet_touch(self):
        self.tablet_service.onTouchDown()
    ...
    def autonomous_blinking(self):
        ...
        if self.speech_service.getAudioExpression():
            print("Disable eye blinking and beeping when ing...")
    ...
    def list_behavior(self):
        ...
        return self.behavior_service.getBehaviorNames()
    ...
    def take_picture(self):
        self.subscribe_camera("camera_top", 3, 30)
    ...
    def listen_to(self, vocabulary, time_listen, language="En"):
        """
    ...
    def speech_to_text(self, audio_file, key=None, lang="vi-VN"):
        """
        ...
        with audio_file as source:
            ...
            recognized = self.recognizer.recognize_google(audio, language=lang, key=key)
        return recognized
    ...
    def recordSound(self, streaming_time):
        self.audio_recorder.stopMicrophonesRecording()
    ...
    # FOR BANKING
    # -------------------------
    def react_command_communication(self, command):
        if u"tài khoản" in command:
            # self.say(u"Bạn làm theo hướng dẫn sau")
            # os.system('python3.10 communication_python3.py --dir {} --text u"Bạn hãy làm theo hướng dẫn sau"'.format(audio_dir + 'taotaikhoan.mp3'))
            # time.sleep(0.5)
            # Pepper do some motion 
            # Play adio
            # self.upload_file(audio_dir + 'taotaikhoan.mp3')
            self.audio_service.playFile('/home/nao/taotaikhoan.mp3')
            self.show_web('https://nganhangonline.net/huong-dan/huong-dan-mo-tai-khoan-ngan-hang-kien-long-bank-ksbank-online-tai-nha.html')
            self.start_behavior('System/animations/Stand/BodyTalk/Speaking/BodyTalk_14')
            time.sleep(10)

            # self.upload_file(audio_dir + 'buoc1.mp3')
            self.audio_service.playFile('/home/nao/buoc1.mp3')
            behavior = random.choice(self.list_bodytalk)
            self.start_behavior(behavior=behavior)
            time.sleep(8)

            # self.upload_file(audio_dir + 'buoc2.mp3')
            self.audio_service.playFile('/home/nao/buoc2.mp3')
            behavior = random.choice(self.list_bodytalk)
            self.start_behavior(behavior=behavior)
            time.sleep(12)

            # self.upload_file(audio_dir + 'buoc3.mp3')
            self.audio_service.playFile('/home/nao/buoc3.mp3')
            behavior = random.choice(self.list_bodytalk)
            self.start_behavior(behavior=behavior)
            time.sleep(19)

            # self.upload_file(audio_dir + 'buoc4.mp3')
            self.audio_service.playFile('/home/nao/buoc4.mp3')
            behavior = random.choice(self.list_bodytalk)
            self.start_behavior(behavior=behavior)
            time.sleep(7)

            # self.upload_file(audio_dir + 'buoc5.mp3')
            self.audio_service.playFile('/home/nao/buoc5.mp3')
            behavior = random.choice(self.list_bodytalk)
            self.start_behavior(behavior=behavior)
            time.sleep(12)

            # self.upload_file(audio_dir + 'buoc6.mp3')
            self.audio_service.playFile('/home/nao/buoc6.mp3')
            behavior = random.choice(self.list_bodytalk)
            self.start_behavior(behavior=behavior)
            time.sleep(7)

            # self.upload_file(audio_dir + 'luuy.mp3')
            self.audio_service.playFile('/home/nao/luuy.mp3')
            behavior = random.choice(self.list_bodytalk)
            self.start_behavior(behavior=behavior)
            time.sleep(10)

        elif u"ngủ" in command:
            # self.say("Call me if you need to create account. Bye bye")
            # os.system('python3.10 communication_python3.py --dir {} --text u"Gọi tôi nếu bạn cần tạo tài khoản. Tạm biệt."'.format(audio_dir + 'ngu.mp3'))
            # time.sleep(0.5)
            # Play adio
            # self.upload_file(audio_dir + 'ngu.mp3')
            self.audio_service.playFile('/home/nao/ngu.mp3')
            self.reset_tablet()
            self.set_volume(20)
            self.start_behavior('System/animations/Stand/Emotions/Negative/Exhausted_2')
            time.sleep(6)
            mymy_active = False

        elif u"Google" in command:
            # self.say("Google is preparing")
            # os.system('python3.10 communication_python3.py --dir {} --text u"Google đang bật"'.format(audio_dir + 'google.mp3'))
            # time.sleep(0.5)
            # Pepper do some motion 
            # Play adio
            # self.upload_file(audio_dir + 'google.mp3')
            behavior = random.choice(self.list_explain)
            self.start_behavior(behavior)
            self.audio_service.playFile('/home/nao/google.mp3')
            self.show_web('https://google.com/')
            time.sleep(6)

        elif u"YouTube" in command:
            # self.say("Youtube is preparing")
            # os.system('python3.10 communication_python3.py --dir {} --text u"Youtube đang bật"'.format(audio_dir + 'youtube.mp3'))
            # time.sleep(0.5)
            # Pepper do some motion 
            # Play adio
            # self.upload_file(audio_dir + 'youtube.mp3')
            behavior = random.choice(self.list_explain)
            self.start_behavior(behavior)
            self.audio_service.playFile('/home/nao/youtube.mp3')
            self.show_web('https://youtube.com/')
            time.sleep(6)

        # -----------------------
        # SERVE TEST ONLY
        # -----------------------
        elif u"tắt đi" in command:
            streaming = False
            mymy_active = False
            self.say('bye')
        # -----------------------
        elif u"dừng lại" in command:
            self.reset_tablet()
            self.stop_sound()
            self.say('bye')
            ...
            # os.system('python3.10 communication_python3.py --dir {} --text u"Tôi không hiểu. Bạn có thể vui lòng nhắc lại không"'.format(audio_dir + 'khonghieu.mp3'))
            # time.sleep(0.5)
            # Pepper do some motion 
            # self.upload_file(audio_dir + 'khonghieu.mp3')
            self.start_behavior('System/animations/Stand/Emotions/Neutral/Confused_1')
            self.audio_service.playFile('/home/nao/khonghieu.mp3')
            time.sleep(8)
        return streaming, mymy_active
    # -------------------------
